...
namespace IBSampleApp.ui
{
    class MarketDataManager : DataManager
    {
        ...
        public void UpdateUI(TickPriceMessage dataMessage)
        {
            ...
            if ((grid[MARKET_DATA_TYPE_INDEX, index].Value.Equals(MarketDataType.Real_Time.Name)) &&
            ...
            {
                grid[MARKET_DATA_TYPE_INDEX, index].Value = MarketDataType.Delayed.Name;
            }
            ...
            switch (dataMessage.Field)
            {
                ...
                case TickType.DELAYED_CLOSE:
                    {
                        //CLOSE, DELAYED_CLOSE
                        grid[CLOSE_PRICE_INDEX, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                case TickType.OPEN:
                case TickType.DELAYED_OPEN:
                    {
                        //OPEN, DELAYED_OPEN
                        grid[OPEN_PRICE_INDEX, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                case TickType.LAST:
                case TickType.DELAYED_LAST:
                    {
                        //LAST, DELAYED_LAST
                        grid[LAST_PRICE_INDEX, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                case TickType.HIGH:
                case TickType.DELAYED_HIGH:
                    {
                        //HIGH, DELAYED_HIGH
                        grid[HIGH_PRICE_INDEX, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                case TickType.LOW:
                case TickType.DELAYED_LOW:
                    {
                        //LOW, DELAYED_LOW
                        grid[LOW_PRICE_INDEX, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                case TickType.ESTIMATED_IPO_MIDPOINT:
                    {
                        //ESTIMATED_IPO_MIDPOINT
                        grid[ESTIMATED_IPO_MIDPOINT, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                case TickType.FINAL_IPO_LAST:
                    {
                        //FINAL_IPO_LAST
                        grid[FINAL_IPO_LAST, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                ...
                case TickType.DELAYED_YIELD_BID:
                    {
                        //BID_YIELD
                        grid[BID_YIELD, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
                ...
                case TickType.DELAYED_YIELD_ASK:
                    {
                        //ASK_YIELD
                        grid[ASK_YIELD, index].Value = Util.DoubleMaxString(dataMessage.Price);
                        break;
                    }
            }
        }
                ...
                case TickType.DELAYED_BID_SIZE:
                    {
                        ...
                        grid[BID_SIZE_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
                ...
                case TickType.DELAYED_ASK_SIZE:
                    {
                        ...
                        grid[ASK_SIZE_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
                ...
                case TickType.DELAYED_LAST_SIZE:
                    {
                        ...
                        grid[LAST_SIZE_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
                ...
                case TickType.DELAYED_VOLUME:
                    {
                        ...
                        grid[VOLUME_SIZE_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
                case TickType.FUTURES_OPEN_INTEREST:
                    {
                        //FUTURES_OPEN_INTEREST
                        grid[FUTURES_OPEN_INTEREST_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
                case TickType.AVG_OPT_VOLUME:
                    {
                        //AVG_OPT_VOLUME
                        grid[AVG_OPT_VOLUME_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
                case TickType.SHORTABLE_SHARES:
                    {
                        //SHORTABLE_SHARES
                        grid[SHORTABLE_SHARES_INDEX, index].Value = Util.DecimalMaxString(dataMessage.Size);
                        break;
                    }
            }
        }
