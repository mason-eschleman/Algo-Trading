...
#ifndef TickAttribLast_2eproto_2epb_2eh
#define TickAttribLast_2eproto_2epb_2eh
...
class TickAttribLast final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:protobuf.TickAttribLast) */ {
 public:
  inline TickAttribLast() : TickAttribLast(nullptr) {}
  ~TickAttribLast() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(TickAttribLast* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(TickAttribLast));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR TickAttribLast(
      ::google::protobuf::internal::ConstantInitialized);

  inline TickAttribLast(const TickAttribLast& from) : TickAttribLast(nullptr, from) {}
  inline TickAttribLast(TickAttribLast&& from) noexcept
      : TickAttribLast(nullptr, std::move(from)) {}
  ...
  friend void swap(TickAttribLast& a, TickAttribLast& b) { a.Swap(&b); }
  ...
  TickAttribLast* New(::google::protobuf::Arena* arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<TickAttribLast>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const TickAttribLast& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const TickAttribLast& from) { TickAttribLast::MergeImpl(*this, from); }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "protobuf.TickAttribLast"; }

 protected:
  explicit TickAttribLast(::google::protobuf::Arena* arena);
  TickAttribLast(::google::protobuf::Arena* arena, const TickAttribLast& from);
  TickAttribLast(::google::protobuf::Arena* arena, TickAttribLast&& from) noexcept
...
#endif  // TickAttribLast_2eproto_2epb_2eh
