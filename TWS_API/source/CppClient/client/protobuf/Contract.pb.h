...
/* @@protoc_insertion_point(class_definition:protobuf.Contract) */ {
 ...
 public:
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_lasttradedate(Arg_&& arg, Args_... args);
  std::string* mutable_lasttradedate();
  PROTOBUF_NODISCARD std::string* release_lasttradedate();
  void set_allocated_lasttradedate(std::string* value);

  private:
  const std::string& _internal_lasttradedate() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_lasttradedate(
      const std::string& value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::ArenaStringPtr lasttradedate_;
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Contract::set_lasttradedate(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.lasttradedate_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:protobuf.Contract.lastTradeDate)
}
inline std::string* Contract::mutable_lasttradedate() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Contract::_internal_set_lasttradedate(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.lasttradedate_.Set(value, GetArena());
}
inline std::string* Contract::_internal_mutable_lasttradedate() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00004000u;
  return _impl_.lasttradedate_.Mutable( GetArena());
}
inline std::string* Contract::release_lasttradedate() {
  ...
  _impl_._has_bits_[0] &= ~0x00004000u;
  auto* released = _impl_.lasttradedate_.Release();
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString()) {
    _impl_.lasttradedate_.Set("", GetArena());
  }
  return released;
}
inline void Contract::set_allocated_lasttradedate(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00004000u;
  } else {
  ...
  _impl_.lasttradedate_.SetAllocated(value, GetArena());
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.lasttradedate_.IsDefault()) {
    _impl_.lasttradedate_.Set("", GetArena());
  }
