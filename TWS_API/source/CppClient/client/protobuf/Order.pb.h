...
/* @@protoc_insertion_point(class_definition:protobuf.Order) */ {
 ...
 public:
  ...
  bool has_hedgemaxsize() const;
  void clear_hedgemaxsize() ;
  ::int32_t hedgemaxsize() const;
  void set_hedgemaxsize(::int32_t value);

  private:
  ::int32_t _internal_hedgemaxsize() const;
  void _internal_set_hedgemaxsize(::int32_t value);
...
// optional int32 hedgeMaxSize = 144;
inline bool Order::has_hedgemaxsize() const {
  bool value = (_impl_._has_bits_[4] & 0x00000800u) != 0;
  return value;
}
inline void Order::clear_hedgemaxsize() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.hedgemaxsize_ = 0;
  _impl_._has_bits_[4] &= ~0x00000800u;
}
inline ::int32_t Order::hedgemaxsize() const {
  // @@protoc_insertion_point(field_get:protobuf.Order.hedgeMaxSize)
  return _internal_hedgemaxsize();
}
inline void Order::set_hedgemaxsize(::int32_t value) {
  _internal_set_hedgemaxsize(value);
  _impl_._has_bits_[4] |= 0x00000800u;
  // @@protoc_insertion_point(field_set:protobuf.Order.hedgeMaxSize)
}
inline ::int32_t Order::_internal_hedgemaxsize() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.hedgemaxsize_;
}
inline void Order::_internal_set_hedgemaxsize(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.hedgemaxsize_ = value;
}
